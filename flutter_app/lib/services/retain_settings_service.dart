...
class RetainSettingsState {
  ...
  factory RetainSettingsState.fromJson(Map<String, dynamic> json) =>
    RetainSettingsState(
      retainTemperature: json['retainTemperature'] as bool? ?? false,
      retainExposure:    json['retainExposure']    as bool? ?? false,
      retainZoom:        json['retainZoom']         as bool? ?? false,
      retainFrame:       json['retainFrame']        as bool? ?? false,
    );
}
...
class CameraSnapshot {
  ...
  factory CameraSnapshot.fromJson(Map<String, dynamic> json) => CameraSnapshot(
    temperatureOffset: (json['temperatureOffset'] as num?)?.toDouble() ?? 0,
    colorTempK:        (json['colorTempK']        as num?)?.toInt()    ?? 6300,
    wbMode:            json['wbMode']             as String?           ?? 'auto',
    exposureValue:     (json['exposureValue']     as num?)?.toDouble() ?? 0,
